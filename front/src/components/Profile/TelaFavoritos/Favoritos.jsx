    ...
    return (
        ...
        <div className={styles.container}>
            <div className={styles.usuario}>
                <img src="../../../assets/imgs/person-card-1.png" alt="Foto de perfil user" className={styles.imgUser} />
                <p className={styles.nickName}>
                    Abel Medeiros
                </p>
                <ul className={styles.fonte}>
                    <li>
                        <img src="../../../assets/imgs/icon-localizacao.png" alt="Icon de localização"
            ...
            <div className={styles.containerDecritivo}>
                <div className={styles.descricao}>
                    ...
                    <p className={styles.bio}>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi facere tempore earum minus, ipsum ducimus!
                    </p>
                </div>
